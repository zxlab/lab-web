...
6.  generate a tree
    ...
    -   其他建树的方法是fragment insertion sepp
7.  diversity analysis
    ...
    -   在coursera课程microbiome中，有关于diversity有生动的说明，请自行移步。另外可参考[Studying Microbial Diversity](http://readiab.org/book/0.1.3/3/1#4.1.2)。
...
-   [mutipage<sub>pdf</sub>](https://matplotlib.org/gallery/misc/multipage_pdf.html) 可同时保存多张图片
